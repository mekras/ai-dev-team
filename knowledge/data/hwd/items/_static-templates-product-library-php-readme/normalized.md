...
- https://packagist.org/packages/foo/bar-bundle — пакет для использования в проектах на Symfony.
...
Установка через Composer. В консоли в корне проекта выполните команду:
