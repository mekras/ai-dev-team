...
корневого входа открой `.agents/skills/ait-routing/SKILL.md`. Если этот путь
недоступен, используй `.claude/skills/ait-routing/SKILL.md`. Первым сообщением
покажи маршрут со строками «Режим менеджера» и «Маршрут».
